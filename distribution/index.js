...
exports.levenshteinDistance = (0, _memoizee2.default)(function (str) {
 ...
 * @param prop
 */
exports.filterResultSet = function filterResultSet(results, pattern) {
 ...
 * @returns {RegExp}
 */
exports.buildFuzzySearchPattern = (0, _memoizee2.default)(function fuzzySearchPattern(q) {
 ...
 * @returns {Array}
 */
exports.sortResultSet = function sortResultSet(results, prop, query, limit) {
 ...
 * @returns {Function} -
 */
exports.createSearchContext = function createSearchContext(model) {
