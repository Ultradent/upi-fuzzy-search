...
function createSearchContext(model) {
    ...
    return {
        setFilters: function setFilters(filters) {
            ...
            _ctxFilters = _filters.filter(function (item) {
        ...
        query: function search(q) {
             ...
             */
            var resultSets = _$cache[query] !== undefined ? _$cache[query] : _$cache[query] = (0, _filterResultSet2.default)(_$cache[prevQuery] || model, queryPattern, props, _ctxFilters);
