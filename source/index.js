...
exports.levenshteinDistance = memoize( str => {
 ...
 * @param prop
 */
exports.filterResultSet = function filterResultSet( results, pattern, props=[] ) {
 ...
 * @returns {RegExp}
 */
exports.buildFuzzySearchPattern = memoize( function fuzzySearchPattern( q ) {
 ...
 * @returns {Function} -
 */
exports.createSearchContext = function createSearchContext( model, props = [], limit ) {
